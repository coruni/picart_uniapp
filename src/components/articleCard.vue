...
<template>
  <view class="relative rounded bg-white" @tap="toArticleDetail">
    ...
    <view class="flex items-center justify-between overflow-hidden px-3 pb-3">
      <view class="flex items-center space-x-2">
        <view class="size-4">
          <ImageCache use-cache border width="100%" mode="widthFix" :src="article.author.avatar || ''" border-radius="9999px" />
        </view>
